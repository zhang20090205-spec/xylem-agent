...
\begin{block}{Product \& Research}
\centering
\vspace{0.05cm}
\textbf{\normalsize \color{secondary}Developer Relations} \\
\vspace{0.05cm}
\textsc{\normalsize Hackathon Team} \\
\vspace{0.05cm}
\begin{itemize}
...
\begin{frame}{Our Solution: Xylem agent}
\vspace{0.05cm}
\begin{center}
\begin{tikzpicture}
...
\textbf{\footnotesize Xylem agent team}\\
\vspace{0.05cm}
\footnotesize AI DeFi product team\\
\vspace{0.05cm}
\footnotesize \faGithub\ @zhang20090205-spec

\column{0.38\textwidth}
\textbf{\footnotesize Hackathon demo}\\
\vspace{0.05cm}
\footnotesize Hedera DeFi assistant\\
\vspace{0.05cm}
\footnotesize \faGithub\ xylem-agent
\end{columns}

\vspace{0.3cm}

\textbf{\footnotesize GitHub:} \hspace{0.2cm} \texttt{\footnotesize github.com/zhang20090205-spec/xylem-agent}

\vspace{0.1cm}

\textbf{\footnotesize Demo:} \texttt{\footnotesize Xylem agent live demo}
\end{center}
\end{frame}
